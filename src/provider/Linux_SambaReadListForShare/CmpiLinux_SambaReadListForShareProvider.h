...
//
// =======================================================================
#ifndef CmpiLinux_SambaReadListForShareProvider_h
#define CmpiLinux_SambaReadListForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaReadListForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaReadListForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaReadListForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaReadListForShareInstanceName& anInstanceNameP,

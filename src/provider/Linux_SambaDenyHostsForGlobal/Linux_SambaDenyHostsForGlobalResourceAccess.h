// =======================================================================
// Linux_SambaDenyHostsForGlobalResourceAccess.h
...
//
//
#ifndef Linux_SambaDenyHostsForGlobalResourceAccess_h
#define Linux_SambaDenyHostsForGlobalResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_SambaDenyHostsForGlobalResourceAccess:
   public Linux_SambaDenyHostsForGlobalDefaultImplementation {

    public:
    /*
    Linux_SambaDenyHostsForGlobalResourceAccess();
    */
    virtual ~Linux_SambaDenyHostsForGlobalResourceAccess() ;

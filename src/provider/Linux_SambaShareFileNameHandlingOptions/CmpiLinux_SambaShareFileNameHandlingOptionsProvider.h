...
//
// =======================================================================
#ifndef CmpiLinux_SambaShareFileNameHandlingOptionsProvider_h
#define CmpiLinux_SambaShareFileNameHandlingOptionsProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaShareFileNameHandlingOptionsProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaShareFileNameHandlingOptionsInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaShareFileNameHandlingOptionsInstanceName& anInstanceNameP,
    ...
    void removeDanglingShadowInstances (
      const Linux_SambaShareFileNameHandlingOptionsInstanceNameEnumeration& anInstanceNameEnumeration);

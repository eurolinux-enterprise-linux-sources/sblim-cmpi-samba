...
//
// =======================================================================
#include "CmpiLinux_SambaGlobalBrowseOptionsProvider.h"
...
namespace genProvider {
  ...
  //----------------------------------------------------------------------------
  CmpiLinux_SambaGlobalBrowseOptionsProvider::CmpiLinux_SambaGlobalBrowseOptionsProvider(
    ...
    m_interfaceP = Linux_SambaGlobalBrowseOptionsFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::completeInstance(
    const Linux_SambaGlobalBrowseOptionsInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_SambaGlobalBrowseOptionsInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_SambaGlobalBrowseOptionsProvider::removeDanglingShadowInstances (
   const Linux_SambaGlobalBrowseOptionsInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  //                          Provider Factory
  //----------------------------------------------------------------------------
  CMProviderBase(CmpiLinux_SambaGlobalBrowseOptionsProvider);

  CMInstanceMIFactory(
    CmpiLinux_SambaGlobalBrowseOptionsProvider, 
    CmpiLinux_SambaGlobalBrowseOptionsProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    Linux_SambaGlobalBrowseOptionsInstanceNameEnumeration enumeration;
    ...
    while (enumeration.hasNext() ){
      const Linux_SambaGlobalBrowseOptionsInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    Linux_SambaGlobalBrowseOptionsManualInstanceEnumeration enumeration;
    ...
    while (enumeration.hasNext()) {
   	  const Linux_SambaGlobalBrowseOptionsManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_SambaGlobalBrowseOptionsInstanceName instanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance) {
   	
   	Linux_SambaGlobalBrowseOptionsManualInstance manualInstance(
      aCmpiInstance,
...
//   	  Linux_SambaGlobalBrowseOptionsRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaGlobalBrowseOptionsProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaGlobalBrowseOptionsProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_SambaGlobalBrowseOptionsInstanceName instanceName = Linux_SambaGlobalBrowseOptionsInstanceName(aCop);
...
//    } catch (CmpiStatus& rc) {}
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaGlobalBrowseOptionsProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,

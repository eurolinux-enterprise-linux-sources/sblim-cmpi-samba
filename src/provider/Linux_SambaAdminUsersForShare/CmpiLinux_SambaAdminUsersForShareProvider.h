// =======================================================================
// CmpiLinux_SambaAdminUsersForShareProvider.h
...
//
// =======================================================================
#ifndef CmpiLinux_SambaAdminUsersForShareProvider_h
#define CmpiLinux_SambaAdminUsersForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaAdminUsersForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaAdminUsersForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaAdminUsersForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaAdminUsersForShareInstanceName& anInstanceNameP,

...
namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaGlobalForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaGlobalForServiceInstanceName& anInstanceNameP,

...
//
// =======================================================================
#ifndef Linux_SambaGlobalForServiceDefaultImplementation_h
#define Linux_SambaGlobalForServiceDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_SambaGlobalForServiceDefaultImplementation:
   public Linux_SambaGlobalForServiceInterface {
  	
    public:    
    virtual ~Linux_SambaGlobalForServiceDefaultImplementation() { };

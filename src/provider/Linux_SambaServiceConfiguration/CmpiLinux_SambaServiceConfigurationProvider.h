...
namespace genProvider{
  ...
  class CmpiLinux_SambaServiceConfigurationProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaServiceConfigurationInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaServiceConfigurationInstanceName& anInstanceNameP,
    ...
    void removeDanglingShadowInstances (
      const Linux_SambaServiceConfigurationInstanceNameEnumeration& anInstanceNameEnumeration);

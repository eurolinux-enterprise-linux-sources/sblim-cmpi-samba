...
namespace genProvider{
  ...
  class CmpiLinux_SambaForceUserForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaForceUserForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaForceUserForGlobalInstanceName& anInstanceNameP,
    ...
    void removeDanglingShadowInstances (
      const Linux_SambaForceUserForGlobalInstanceNameEnumeration& anInstanceNameEnumeration);

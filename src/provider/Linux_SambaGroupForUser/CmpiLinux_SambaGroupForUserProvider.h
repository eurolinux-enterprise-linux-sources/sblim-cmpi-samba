...
//
// =======================================================================
#ifndef CmpiLinux_SambaGroupForUserProvider_h
#define CmpiLinux_SambaGroupForUserProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaGroupForUserFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaGroupForUserProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaGroupForUserInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaGroupForUserInstanceName& anInstanceNameP,

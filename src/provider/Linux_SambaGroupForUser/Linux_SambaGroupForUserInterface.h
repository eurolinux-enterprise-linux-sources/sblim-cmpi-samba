...
namespace genProvider {
  ...
  class Linux_SambaGroupForUserInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaGroupForUserInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaGroupForUserManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaGroupForUserManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaGroupForUserInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaGroupForUserManualInstance& aManualInstance) = 0;

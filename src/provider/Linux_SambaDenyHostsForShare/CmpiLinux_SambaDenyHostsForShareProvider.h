...
//
// =======================================================================
#ifndef CmpiLinux_SambaDenyHostsForShareProvider_h
#define CmpiLinux_SambaDenyHostsForShareProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaDenyHostsForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaDenyHostsForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaDenyHostsForShareInstanceName& anInstanceNameP,

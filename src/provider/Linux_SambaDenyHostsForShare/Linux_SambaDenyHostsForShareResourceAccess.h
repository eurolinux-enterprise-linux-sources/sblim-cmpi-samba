...
//
//
#ifndef Linux_SambaDenyHostsForShareResourceAccess_h
#define Linux_SambaDenyHostsForShareResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_SambaDenyHostsForShareResourceAccess:
   public Linux_SambaDenyHostsForShareDefaultImplementation {

    public:
    /*
    Linux_SambaDenyHostsForShareResourceAccess();
    */
    virtual ~Linux_SambaDenyHostsForShareResourceAccess() ;

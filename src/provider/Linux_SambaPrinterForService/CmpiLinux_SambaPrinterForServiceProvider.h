...
//
// =======================================================================
#ifndef CmpiLinux_SambaPrinterForServiceProvider_h
#define CmpiLinux_SambaPrinterForServiceProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaPrinterForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaPrinterForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaPrinterForServiceInstanceName& anInstanceNameP,

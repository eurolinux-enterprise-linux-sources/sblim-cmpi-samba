...
//
// =======================================================================
#ifndef CmpiLinux_SambaValidUsersForPrinterProvider_h
#define CmpiLinux_SambaValidUsersForPrinterProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaValidUsersForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaValidUsersForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaValidUsersForPrinterInstanceName& anInstanceNameP,

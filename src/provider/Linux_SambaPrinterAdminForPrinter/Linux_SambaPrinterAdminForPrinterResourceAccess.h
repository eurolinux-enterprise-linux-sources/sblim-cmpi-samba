// =======================================================================
// Linux_SambaPrinterAdminForPrinterResourceAccess.h
...
//
// 
#ifndef Linux_SambaPrinterAdminForPrinterResourceAccess_h
#define Linux_SambaPrinterAdminForPrinterResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_SambaPrinterAdminForPrinterResourceAccess:
   public Linux_SambaPrinterAdminForPrinterDefaultImplementation {
  	
    public:
    /*
    Linux_SambaPrinterAdminForPrinterResourceAccess();
    */    
    virtual ~Linux_SambaPrinterAdminForPrinterResourceAccess() ;

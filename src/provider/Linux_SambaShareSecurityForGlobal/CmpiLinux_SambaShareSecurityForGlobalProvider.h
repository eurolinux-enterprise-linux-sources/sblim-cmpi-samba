// =======================================================================
// CmpiLinux_SambaShareSecurityForGlobalProvider.h
...
//
// =======================================================================
#ifndef CmpiLinux_SambaShareSecurityForGlobalProvider_h
#define CmpiLinux_SambaShareSecurityForGlobalProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaShareSecurityForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaShareSecurityForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaShareSecurityForGlobalInstanceName& anInstanceNameP,

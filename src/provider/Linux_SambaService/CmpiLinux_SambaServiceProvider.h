...
//
// =======================================================================
#ifndef CmpiLinux_SambaServiceProvider_h
#define CmpiLinux_SambaServiceProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaServiceInstanceName& anInstanceNameP,

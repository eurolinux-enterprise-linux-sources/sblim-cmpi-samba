...
//
// =======================================================================
#ifndef CmpiLinux_SambaServiceConfigurationForServiceProvider_h
#define CmpiLinux_SambaServiceConfigurationForServiceProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaServiceConfigurationForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaServiceConfigurationForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaServiceConfigurationForServiceInstanceName& anInstanceNameP,

// =======================================================================
// CmpiLinux_SambaAdminUsersForGlobalProvider.h
...
//
// =======================================================================
#ifndef CmpiLinux_SambaAdminUsersForGlobalProvider_h
#define CmpiLinux_SambaAdminUsersForGlobalProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaAdminUsersForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaAdminUsersForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaAdminUsersForGlobalInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaAdminUsersForGlobalProvider(

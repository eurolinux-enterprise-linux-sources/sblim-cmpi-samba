...
//
// =======================================================================
#ifndef Linux_SambaAllowHostsForPrinterInterface_h
#define Linux_SambaAllowHostsForPrinterInterface_h
...
namespace genProvider {
  ...
  class Linux_SambaAllowHostsForPrinterInterface {
  	
    public:    
    virtual ~Linux_SambaAllowHostsForPrinterInterface() { };
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaAllowHostsForPrinterInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaAllowHostsForPrinterManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaAllowHostsForPrinterManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaAllowHostsForPrinterInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaAllowHostsForPrinterManualInstance& aManualInstance) = 0;

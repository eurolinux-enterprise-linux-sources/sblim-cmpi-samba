...
//
// =======================================================================
#ifndef CmpiLinux_SambaAllowHostsForPrinterProvider_h
#define CmpiLinux_SambaAllowHostsForPrinterProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaAllowHostsForPrinterFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaAllowHostsForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaAllowHostsForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaAllowHostsForPrinterInstanceName& anInstanceNameP,

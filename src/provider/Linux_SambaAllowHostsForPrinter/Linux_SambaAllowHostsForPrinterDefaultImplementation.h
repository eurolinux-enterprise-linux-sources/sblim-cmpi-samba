...
//
// =======================================================================
#ifndef Linux_SambaAllowHostsForPrinterDefaultImplementation_h
#define Linux_SambaAllowHostsForPrinterDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_SambaAllowHostsForPrinterDefaultImplementation:
   public Linux_SambaAllowHostsForPrinterInterface {
  	
    public:    
    virtual ~Linux_SambaAllowHostsForPrinterDefaultImplementation() { };

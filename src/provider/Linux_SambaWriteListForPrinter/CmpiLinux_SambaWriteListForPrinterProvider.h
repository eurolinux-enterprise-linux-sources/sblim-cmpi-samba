...
//
// =======================================================================
#ifndef CmpiLinux_SambaWriteListForPrinterProvider_h
#define CmpiLinux_SambaWriteListForPrinterProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaWriteListForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaWriteListForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaWriteListForPrinterInstanceName& anInstanceNameP,

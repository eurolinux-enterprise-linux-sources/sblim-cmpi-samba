...
//
// =======================================================================
#ifndef CmpiLinux_SambaShareForServiceProvider_h
#define CmpiLinux_SambaShareForServiceProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaShareForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaShareForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaShareForServiceInstanceName& anInstanceNameP,

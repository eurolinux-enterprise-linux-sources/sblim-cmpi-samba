...
namespace genProvider{
  ...
  class CmpiLinux_SambaShareSecurityOptionsProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaShareSecurityOptionsInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaShareSecurityOptionsInstanceName& anInstanceNameP,

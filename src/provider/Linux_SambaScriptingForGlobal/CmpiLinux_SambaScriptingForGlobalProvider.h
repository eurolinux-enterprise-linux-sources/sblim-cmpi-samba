...
//
// =======================================================================
#ifndef CmpiLinux_SambaScriptingForGlobalProvider_h
#define CmpiLinux_SambaScriptingForGlobalProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaScriptingForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaScriptingForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaScriptingForGlobalInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaScriptingForGlobalProvider(

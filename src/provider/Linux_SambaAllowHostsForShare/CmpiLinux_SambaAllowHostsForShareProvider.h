...
//
// =======================================================================
#ifndef CmpiLinux_SambaAllowHostsForShareProvider_h
#define CmpiLinux_SambaAllowHostsForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaAllowHostsForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaAllowHostsForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaAllowHostsForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaAllowHostsForShareInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaAllowHostsForShareProvider(

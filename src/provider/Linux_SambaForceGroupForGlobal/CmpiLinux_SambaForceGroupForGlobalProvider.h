...
//
// =======================================================================
#ifndef CmpiLinux_SambaForceGroupForGlobalProvider_h
#define CmpiLinux_SambaForceGroupForGlobalProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaForceGroupForGlobalFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaForceGroupForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaForceGroupForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaForceGroupForGlobalInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaForceGroupForGlobalProvider(

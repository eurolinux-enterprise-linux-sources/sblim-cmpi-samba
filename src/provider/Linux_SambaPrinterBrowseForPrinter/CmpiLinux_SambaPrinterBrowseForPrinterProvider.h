...
//
// =======================================================================
#ifndef CmpiLinux_SambaPrinterBrowseForPrinterProvider_h
#define CmpiLinux_SambaPrinterBrowseForPrinterProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaPrinterBrowseForPrinterFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaPrinterBrowseForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaPrinterBrowseForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaPrinterBrowseForPrinterInstanceName& anInstanceNameP,

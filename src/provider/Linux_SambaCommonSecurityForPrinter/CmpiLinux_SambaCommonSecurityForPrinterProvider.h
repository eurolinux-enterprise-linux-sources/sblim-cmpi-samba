...
//
// =======================================================================
#ifndef CmpiLinux_SambaCommonSecurityForPrinterProvider_h
#define CmpiLinux_SambaCommonSecurityForPrinterProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaCommonSecurityForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaCommonSecurityForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaCommonSecurityForPrinterInstanceName& anInstanceNameP,

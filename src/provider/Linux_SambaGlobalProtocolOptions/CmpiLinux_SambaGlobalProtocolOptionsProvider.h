...
//
// =======================================================================
#ifndef CmpiLinux_SambaGlobalProtocolOptionsProvider_h
#define CmpiLinux_SambaGlobalProtocolOptionsProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalProtocolOptionsProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaGlobalProtocolOptionsInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaGlobalProtocolOptionsInstanceName& anInstanceNameP,

...
//
// =======================================================================
#ifndef CmpiLinux_SambaPrinterPrintingForPrinterProvider_h
#define CmpiLinux_SambaPrinterPrintingForPrinterProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaPrinterPrintingForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaPrinterPrintingForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaPrinterPrintingForPrinterInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaPrinterPrintingForPrinterProvider(

...
namespace genProvider {
  ...
  class Linux_SambaPrinterPrintingOptionsInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaPrinterPrintingOptionsInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaPrinterPrintingOptionsManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaPrinterPrintingOptionsManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaPrinterPrintingOptionsInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaPrinterPrintingOptionsManualInstance& aManualInstance) = 0;

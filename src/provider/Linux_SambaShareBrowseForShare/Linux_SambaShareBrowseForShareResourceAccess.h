...
//
// 
#ifndef Linux_SambaShareBrowseForShareResourceAccess_h
#define Linux_SambaShareBrowseForShareResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_SambaShareBrowseForShareResourceAccess:
   public Linux_SambaShareBrowseForShareDefaultImplementation {
  	
    public:
    /*
    Linux_SambaShareBrowseForShareResourceAccess();
    */    
    virtual ~Linux_SambaShareBrowseForShareResourceAccess() ;
    ...
    virtual Linux_SambaShareBrowseForShareManualInstance getInstance(
      const CmpiContext& aContext,
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,

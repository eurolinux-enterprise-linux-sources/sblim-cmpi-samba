...
//
// =======================================================================
#ifndef CmpiLinux_SambaShareBrowseForShareProvider_h
#define CmpiLinux_SambaShareBrowseForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaShareBrowseForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaShareBrowseForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaShareBrowseForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaShareBrowseForShareInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaShareBrowseForShareProvider(

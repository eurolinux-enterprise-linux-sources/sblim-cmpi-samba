...
//
// =======================================================================
#ifndef CmpiLinux_SambaCommonSecurityOptionsProvider_h
#define CmpiLinux_SambaCommonSecurityOptionsProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaCommonSecurityOptionsFactory.h"


namespace genProvider{

  class CmpiLinux_SambaCommonSecurityOptionsProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaCommonSecurityOptionsInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaCommonSecurityOptionsInstanceName& anInstanceNameP,

...
namespace genProvider {
  ...
  class Linux_SambaCommonSecurityOptionsInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaCommonSecurityOptionsInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaCommonSecurityOptionsManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaCommonSecurityOptionsManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaCommonSecurityOptionsInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaCommonSecurityOptionsManualInstance& aManualInstance) = 0;

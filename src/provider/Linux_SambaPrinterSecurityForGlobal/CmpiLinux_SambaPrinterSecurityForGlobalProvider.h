...
//
// =======================================================================
#ifndef CmpiLinux_SambaPrinterSecurityForGlobalProvider_h
#define CmpiLinux_SambaPrinterSecurityForGlobalProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaPrinterSecurityForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaPrinterSecurityForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaPrinterSecurityForGlobalInstanceName& anInstanceNameP,

...
//
// =======================================================================
#ifndef CmpiLinux_SambaForceGroupForShareProvider_h
#define CmpiLinux_SambaForceGroupForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaForceGroupForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaForceGroupForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaForceGroupForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaForceGroupForShareInstanceName& anInstanceNameP,

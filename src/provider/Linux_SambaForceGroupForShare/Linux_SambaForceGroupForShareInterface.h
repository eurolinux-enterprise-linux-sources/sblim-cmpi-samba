...
namespace genProvider {
  ...
  class Linux_SambaForceGroupForShareInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaForceGroupForShareInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaForceGroupForShareManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaForceGroupForShareManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaForceGroupForShareInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaForceGroupForShareManualInstance& aManualInstance) = 0;

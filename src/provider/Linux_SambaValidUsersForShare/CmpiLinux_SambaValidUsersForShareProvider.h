...
//
// =======================================================================
#ifndef CmpiLinux_SambaValidUsersForShareProvider_h
#define CmpiLinux_SambaValidUsersForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaValidUsersForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaValidUsersForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaValidUsersForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaValidUsersForShareInstanceName& anInstanceNameP,

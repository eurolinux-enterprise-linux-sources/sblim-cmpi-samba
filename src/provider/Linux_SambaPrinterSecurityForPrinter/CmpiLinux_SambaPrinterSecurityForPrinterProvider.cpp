...
namespace genProvider {
  ...
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::CmpiLinux_SambaPrinterSecurityForPrinterProvider(
    ...
    m_interfaceP = Linux_SambaPrinterSecurityForPrinterFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::completeInstance(
    const Linux_SambaPrinterSecurityForPrinterInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_SambaPrinterSecurityForPrinterInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::removeDanglingShadowInstances (
   const Linux_SambaPrinterSecurityForPrinterInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  CMMethodMIFactory(
    CmpiLinux_SambaPrinterSecurityForPrinterProvider, 
    CmpiLinux_SambaPrinterSecurityForPrinterProvider);    CMAssociationMIFactory(
      CmpiLinux_SambaPrinterSecurityForPrinterProvider,
      CmpiLinux_SambaPrinterSecurityForPrinterProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    while (enumeration.hasNext() ){
      const Linux_SambaPrinterSecurityForPrinterInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    while (enumeration.hasNext()) {
   	  const Linux_SambaPrinterSecurityForPrinterManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_SambaPrinterSecurityForPrinterInstanceName instanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
...
//   	  Linux_SambaPrinterSecurityForPrinterRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_SambaPrinterSecurityForPrinterInstanceName instanceName = Linux_SambaPrinterSecurityForPrinterInstanceName(aCop);
...
//    } catch (CmpiStatus& rc) {}
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::associationLogic( 
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    ...
    if( aReferenceFlag == 0 && anInstanceFlag == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaPrinterSecurityForPrinterManualInstance manualInstance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::associators(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
...
#ifdef DEBUG
    std::cout << "calling associators() of class Linux_SambaPrinterSecurityForPrinter" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::associatorNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling associatorNames() of class Linux_SambaPrinterSecurityForPrinter" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::references( 
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling aReferenceFlag() of class Linux_SambaPrinterSecurityForPrinter" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaPrinterSecurityForPrinterProvider::referenceNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling referenceNames() of class Linux_SambaPrinterSecurityForPrinter" << std::endl;
#endif    

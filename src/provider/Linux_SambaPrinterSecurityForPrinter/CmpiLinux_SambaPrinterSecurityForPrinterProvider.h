...
//
// =======================================================================
#ifndef CmpiLinux_SambaPrinterSecurityForPrinterProvider_h
#define CmpiLinux_SambaPrinterSecurityForPrinterProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaPrinterSecurityForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaPrinterSecurityForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaPrinterSecurityForPrinterInstanceName& anInstanceNameP,

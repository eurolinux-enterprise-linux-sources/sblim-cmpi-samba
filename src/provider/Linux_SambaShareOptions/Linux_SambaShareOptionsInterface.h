...
namespace genProvider {
  ...
  class Linux_SambaShareOptionsInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaShareOptionsInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaShareOptionsManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaShareOptionsManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaShareOptionsInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaShareOptionsManualInstance& aManualInstance) = 0;

...
//
// =======================================================================
#ifndef Linux_SambaInvalidUsersForPrinterDefaultImplementation_h
#define Linux_SambaInvalidUsersForPrinterDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_SambaInvalidUsersForPrinterDefaultImplementation:
   public Linux_SambaInvalidUsersForPrinterInterface {
  	
    public:    
    virtual ~Linux_SambaInvalidUsersForPrinterDefaultImplementation() { };

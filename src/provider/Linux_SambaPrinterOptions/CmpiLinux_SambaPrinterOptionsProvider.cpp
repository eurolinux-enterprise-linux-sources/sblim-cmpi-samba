...
//
// =======================================================================
#include "CmpiLinux_SambaPrinterOptionsProvider.h"
...
namespace genProvider {
  ...
  //----------------------------------------------------------------------------
  CmpiLinux_SambaPrinterOptionsProvider::CmpiLinux_SambaPrinterOptionsProvider(
    ...
    m_interfaceP = Linux_SambaPrinterOptionsFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_SambaPrinterOptionsProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaPrinterOptionsProvider::completeInstance(
    const Linux_SambaPrinterOptionsInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_SambaPrinterOptionsInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaPrinterOptionsProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_SambaPrinterOptionsProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_SambaPrinterOptionsProvider::removeDanglingShadowInstances (
   const Linux_SambaPrinterOptionsInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  //                          Provider Factory
  //----------------------------------------------------------------------------
  CMProviderBase(CmpiLinux_SambaPrinterOptionsProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterOptionsProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    Linux_SambaPrinterOptionsInstanceNameEnumeration enumeration;
    ...
    while (enumeration.hasNext() ){
      const Linux_SambaPrinterOptionsInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterOptionsProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    Linux_SambaPrinterOptionsManualInstanceEnumeration enumeration;
    ...
    while (enumeration.hasNext()) {
   	  const Linux_SambaPrinterOptionsManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterOptionsProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_SambaPrinterOptionsInstanceName instanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterOptionsProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance) {
   	
   	Linux_SambaPrinterOptionsManualInstance manualInstance(
      aCmpiInstance,
...
//   	  Linux_SambaPrinterOptionsRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaPrinterOptionsProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaPrinterOptionsProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_SambaPrinterOptionsInstanceName instanceName = Linux_SambaPrinterOptionsInstanceName(aCop);
...
//    } catch (CmpiStatus& rc) {}
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaPrinterOptionsProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    ...
    Linux_SambaPrinterOptionsInstanceName instanceName = Linux_SambaPrinterOptionsInstanceName();
     
    if (0 == strcasecmp(aMethodNameP,"getAllSystemDefinedPrinters")) {

#ifdef DEBUG
      std::cout << "executing method getAllSystemDefinedPrinters" << std::endl;
#endif      
        
      aResult.returnData(CmpiData(m_interfaceP->getAllSystemDefinedPrinters(
        aContext,
        m_cmpiBroker,
        instanceName)));
...
#ifdef DEBUG
      std::cout << "end of method getAllSystemDefinedPrinters" << std::endl;
#endif      

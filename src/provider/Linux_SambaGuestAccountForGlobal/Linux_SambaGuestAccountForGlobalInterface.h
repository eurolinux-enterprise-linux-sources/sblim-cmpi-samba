...
namespace genProvider {
  ...
  class Linux_SambaGuestAccountForGlobalInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaGuestAccountForGlobalInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaGuestAccountForGlobalManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaGuestAccountForGlobalManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaGuestAccountForGlobalInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaGuestAccountForGlobalManualInstance& aManualInstance) = 0;

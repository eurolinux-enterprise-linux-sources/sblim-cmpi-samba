...
//
// =======================================================================
#ifndef CmpiLinux_SambaGuestAccountForGlobalProvider_h
#define CmpiLinux_SambaGuestAccountForGlobalProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaGuestAccountForGlobalFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaGuestAccountForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaGuestAccountForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaGuestAccountForGlobalInstanceName& anInstanceNameP,

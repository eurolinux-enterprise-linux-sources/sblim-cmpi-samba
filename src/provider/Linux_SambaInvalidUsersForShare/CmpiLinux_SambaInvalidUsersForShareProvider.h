...
//
// =======================================================================
#ifndef CmpiLinux_SambaInvalidUsersForShareProvider_h
#define CmpiLinux_SambaInvalidUsersForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaInvalidUsersForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaInvalidUsersForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaInvalidUsersForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaInvalidUsersForShareInstanceName& anInstanceNameP,

...
//
// =======================================================================
#ifndef CmpiLinux_SambaCommonSecurityForShareProvider_h
#define CmpiLinux_SambaCommonSecurityForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaCommonSecurityForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaCommonSecurityForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaCommonSecurityForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaCommonSecurityForShareInstanceName& anInstanceNameP,

...
namespace genProvider {
  ...
  class Linux_SambaCommonSecurityForShareInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaCommonSecurityForShareInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaCommonSecurityForShareManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaCommonSecurityForShareManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaCommonSecurityForShareInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaCommonSecurityForShareManualInstance& aManualInstance) = 0;

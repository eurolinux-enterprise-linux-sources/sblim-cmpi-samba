...
//
// =======================================================================
#ifndef CmpiLinux_SambaGlobalPrintingForGlobalProvider_h
#define CmpiLinux_SambaGlobalPrintingForGlobalProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaGlobalPrintingForGlobalFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaGlobalPrintingForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaGlobalPrintingForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaGlobalPrintingForGlobalInstanceName& anInstanceNameP,

...
//
// =======================================================================
#ifndef CmpiLinux_SambaGlobalSecurityOptionsProvider_h
#define CmpiLinux_SambaGlobalSecurityOptionsProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalSecurityOptionsProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaGlobalSecurityOptionsInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaGlobalSecurityOptionsInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaGlobalSecurityOptionsProvider(

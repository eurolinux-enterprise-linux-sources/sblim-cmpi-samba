...
//
// =======================================================================
#ifndef Linux_SambaGroupDefaultImplementation_h
#define Linux_SambaGroupDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_SambaGroupDefaultImplementation:
   public Linux_SambaGroupInterface {
  	
    public:    
    virtual ~Linux_SambaGroupDefaultImplementation() { };

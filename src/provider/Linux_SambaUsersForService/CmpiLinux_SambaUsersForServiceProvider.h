...
//
// =======================================================================
#ifndef CmpiLinux_SambaUsersForServiceProvider_h
#define CmpiLinux_SambaUsersForServiceProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaUsersForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaUsersForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaUsersForServiceInstanceName& anInstanceNameP,

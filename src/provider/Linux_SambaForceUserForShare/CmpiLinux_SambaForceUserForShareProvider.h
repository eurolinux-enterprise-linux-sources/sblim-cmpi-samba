...
//
// =======================================================================
#ifndef CmpiLinux_SambaForceUserForShareProvider_h
#define CmpiLinux_SambaForceUserForShareProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaForceUserForShareFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaForceUserForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaForceUserForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaForceUserForShareInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaForceUserForShareProvider(

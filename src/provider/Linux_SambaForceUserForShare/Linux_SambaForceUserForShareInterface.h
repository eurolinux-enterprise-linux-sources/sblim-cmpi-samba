...
namespace genProvider {
  ...
  class Linux_SambaForceUserForShareInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaForceUserForShareInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaForceUserForShareManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaForceUserForShareManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaForceUserForShareInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaForceUserForShareManualInstance& aManualInstance) = 0;

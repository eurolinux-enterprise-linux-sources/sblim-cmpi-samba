...
//
// =======================================================================
#ifndef CmpiLinux_SambaForceGroupForPrinterProvider_h
#define CmpiLinux_SambaForceGroupForPrinterProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_SambaForceGroupForPrinterFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_SambaForceGroupForPrinterProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaForceGroupForPrinterInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaForceGroupForPrinterInstanceName& anInstanceNameP,

...
namespace genProvider{
  ...
  class CmpiLinux_SambaScriptingOptionsProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_SambaScriptingOptionsInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaScriptingOptionsInstanceName& anInstanceNameP,

...
namespace genProvider {
  ...
  class Linux_SambaPrinterAdminForGlobalInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaPrinterAdminForGlobalInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaPrinterAdminForGlobalManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaPrinterAdminForGlobalManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaPrinterAdminForGlobalInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaPrinterAdminForGlobalManualInstance& aManualInstance) = 0;

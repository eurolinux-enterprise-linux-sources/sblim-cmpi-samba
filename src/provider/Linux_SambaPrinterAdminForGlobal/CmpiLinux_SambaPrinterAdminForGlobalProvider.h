...
//
// =======================================================================
#ifndef CmpiLinux_SambaPrinterAdminForGlobalProvider_h
#define CmpiLinux_SambaPrinterAdminForGlobalProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaPrinterAdminForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaPrinterAdminForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaPrinterAdminForGlobalInstanceName& anInstanceNameP,

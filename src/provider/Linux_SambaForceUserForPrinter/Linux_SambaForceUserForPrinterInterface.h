...
namespace genProvider {
  ...
  class Linux_SambaForceUserForPrinterInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaForceUserForPrinterInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaForceUserForPrinterManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaForceUserForPrinterManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaForceUserForPrinterInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaForceUserForPrinterManualInstance& aManualInstance) = 0;

...
namespace genProvider {
  ...
  class Linux_SambaWriteListForGlobalInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_SambaWriteListForGlobalInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_SambaWriteListForGlobalManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_SambaWriteListForGlobalManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaWriteListForGlobalInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_SambaWriteListForGlobalManualInstance& aManualInstance) = 0;

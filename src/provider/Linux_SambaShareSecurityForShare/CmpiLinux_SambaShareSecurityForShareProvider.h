// =======================================================================
// CmpiLinux_SambaShareSecurityForShareProvider.h
...
//
// =======================================================================
#ifndef CmpiLinux_SambaShareSecurityForShareProvider_h
#define CmpiLinux_SambaShareSecurityForShareProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaShareSecurityForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaShareSecurityForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaShareSecurityForShareInstanceName& anInstanceNameP,
    ...
    void removeDanglingShadowInstances (
      const Linux_SambaShareSecurityForShareInstanceNameEnumeration& anInstanceNameEnumeration);

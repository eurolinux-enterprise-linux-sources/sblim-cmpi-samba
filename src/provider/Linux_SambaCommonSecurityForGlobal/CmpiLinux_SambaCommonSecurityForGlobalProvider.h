...
//
// =======================================================================
#ifndef CmpiLinux_SambaCommonSecurityForGlobalProvider_h
#define CmpiLinux_SambaCommonSecurityForGlobalProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaCommonSecurityForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaCommonSecurityForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaCommonSecurityForGlobalInstanceName& anInstanceNameP,
    ...
    CmpiLinux_SambaCommonSecurityForGlobalProvider(

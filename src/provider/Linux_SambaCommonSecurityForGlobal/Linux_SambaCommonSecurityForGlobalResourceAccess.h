...
//
// 
#ifndef Linux_SambaCommonSecurityForGlobalResourceAccess_h
#define Linux_SambaCommonSecurityForGlobalResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_SambaCommonSecurityForGlobalResourceAccess:
   public Linux_SambaCommonSecurityForGlobalDefaultImplementation {
  	
    public:
    /*
    Linux_SambaCommonSecurityForGlobalResourceAccess();
    */    
    virtual ~Linux_SambaCommonSecurityForGlobalResourceAccess() ;

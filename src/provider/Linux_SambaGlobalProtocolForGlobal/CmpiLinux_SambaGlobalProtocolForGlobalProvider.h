...
//
// =======================================================================
#ifndef CmpiLinux_SambaGlobalProtocolForGlobalProvider_h
#define CmpiLinux_SambaGlobalProtocolForGlobalProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaGlobalProtocolForGlobalProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaGlobalProtocolForGlobalInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaGlobalProtocolForGlobalInstanceName& anInstanceNameP,

...
//
// =======================================================================
#ifndef CmpiLinux_SambaShareFileNameHandlingForShareProvider_h
#define CmpiLinux_SambaShareFileNameHandlingForShareProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_SambaShareFileNameHandlingForShareProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_SambaShareFileNameHandlingForShareInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_SambaShareFileNameHandlingForShareInstanceName& anInstanceNameP,
    ...
    void removeDanglingShadowInstances (
      const Linux_SambaShareFileNameHandlingForShareInstanceNameEnumeration& anInstanceNameEnumeration);

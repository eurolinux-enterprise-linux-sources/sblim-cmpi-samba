...
namespace genProvider {
  ...
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::CmpiLinux_SambaShareFileNameHandlingForShareProvider(
    ...
    m_interfaceP = Linux_SambaShareFileNameHandlingForShareFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::completeInstance(
    const Linux_SambaShareFileNameHandlingForShareInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_SambaShareFileNameHandlingForShareInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::removeDanglingShadowInstances (
   const Linux_SambaShareFileNameHandlingForShareInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  CMMethodMIFactory(
    CmpiLinux_SambaShareFileNameHandlingForShareProvider, 
    CmpiLinux_SambaShareFileNameHandlingForShareProvider);    CMAssociationMIFactory(
      CmpiLinux_SambaShareFileNameHandlingForShareProvider,
      CmpiLinux_SambaShareFileNameHandlingForShareProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    while (enumeration.hasNext() ){
      const Linux_SambaShareFileNameHandlingForShareInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    while (enumeration.hasNext()) {
   	  const Linux_SambaShareFileNameHandlingForShareManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_SambaShareFileNameHandlingForShareInstanceName instanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
...
//   	  Linux_SambaShareFileNameHandlingForShareRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_SambaShareFileNameHandlingForShareInstanceName instanceName = Linux_SambaShareFileNameHandlingForShareInstanceName(aCop);
...
//    } catch (CmpiStatus& rc) {}
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::associationLogic( 
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    ...
    if( aReferenceFlag == 0 && anInstanceFlag == 1 ) {
      ...
      if (aCop.classPathIsA("Linux_SambaShareFileNameHandlingOptions")) {
        
        Linux_SambaShareOptionsInstanceEnumeration enumeration;
        Linux_SambaShareFileNameHandlingOptionsInstanceName SettingData(aCop);
        ...
        while(enumeration.hasNext()) {
          const Linux_SambaShareFileNameHandlingOptionsInstance instance = enumeration.getNext();
          CmpiInstance cmpiInstance = instance.getCmpiInstance(aPropertiesPP);
          aResult.returnData(cmpiInstance);
        }
      }   
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_SambaShareFileNameHandlingForShareManualInstance manualInstance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::associators(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
...
#ifdef DEBUG
    std::cout << "calling associators() of class Linux_SambaShareFileNameHandlingForShare" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::associatorNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling associatorNames() of class Linux_SambaShareFileNameHandlingForShare" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::references( 
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling aReferenceFlag() of class Linux_SambaShareFileNameHandlingForShare" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_SambaShareFileNameHandlingForShareProvider::referenceNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling referenceNames() of class Linux_SambaShareFileNameHandlingForShare" << std::endl;
#endif    
